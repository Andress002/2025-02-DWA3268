...
public class AccountController {
    ...
    public ResponseEntity<String> updateBalance(@PathVariable Long id, @RequestBody AccountRequestDTO dto) {
        ...
        if (msg.equals("Cuenta no encontrada")) return ResponseEntity.status(404).body(msg);
    ...
    public ResponseEntity<?> findByAccountNumber(@PathVariable String numeroCuenta) {
